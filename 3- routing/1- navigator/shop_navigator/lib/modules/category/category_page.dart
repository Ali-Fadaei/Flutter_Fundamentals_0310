...
class CategoryPage extends StatelessWidget {
  //
  static const String path = '/CategoryPage/:id';
  final int categoryId;
  final CategoryData? initialData;
  const CategoryPage({super.key, required this.categoryId, this.initialData});
              ...
              return Scaffold(
                ...
                body: Column(
                  children: [
                    ...
                    IconButton(
                      onPressed: () {
                        GoRouter.of(context).pushNamed(PageB.route);
                      },
