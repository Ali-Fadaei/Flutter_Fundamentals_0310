...
class StoreCubit extends Cubit<StoreState> {
  //
  StoreCubit() : super(StoreState.init()) {
    emit(
      state.copyWith(
        categories: [
          CategoryData(
      ...
      state.copyWith(
        products: [
          Product(
            ...
            categoryData: state.categories[0],
          ),
          Product(
          ...
          Product(
            ...
            categoryData: state.categories[1],
          ),
          Product(
          ...
          Product(
            ...
            categoryData: state.categories[2],
          ),
          Product(
          ...
          Product(
            ...
            categoryData: state.categories[3],
          ),
          Product(
            title: 'Asus RT-AX89X',
            rating: 4.7,
